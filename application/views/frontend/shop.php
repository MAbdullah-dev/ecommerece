...
<main>
        ...
        <div class="category-area">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8 ">
                        ...
                        <div class="new-arrival new-arrival2">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-new-arrival mb-50 text-center">
                                        <div class="popular-img">
                                            <img src="<?php echo BASEURL ?>assets/img/gallery/arrival2.png" alt="">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-new-arrival mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="<?php echo BASEURL ?>assets/img/gallery/arrival3.png" alt="">
                                        <div class="favorit-items">
                                            <!-- <span class="flaticon-heart"></span> -->
                                            <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="single-new-arrival mb-50 text-center">
                                <div class="popular-img">
                                    <img src="<?php echo BASEURL ?>assets/img/gallery/arrival4.png" alt="">
                                    <div class="favorit-items">
                                        <!-- <span class="flaticon-heart"></span> -->
                                        <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                                    </div>
                    ...
                    <div class="col-xl43 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-arrival mb-50 text-center">
                            <div class="popular-img">
                                <img src="<?php echo BASEURL ?>assets/img/gallery/arrival5.png" alt="">
                                <div class="favorit-items">
                                    <!-- <span class="flaticon-heart"></span> -->
                                    <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-new-arrival mb-50 text-center">
                        <div class="popular-img">
                            <img src="<?php echo BASEURL ?>assets/img/gallery/arrival6.png" alt="">
                            <div class="favorit-items">
                                <!-- <span class="flaticon-heart"></span> -->
                                <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="single-new-arrival mb-50 text-center">
                    <div class="popular-img">
                        <img src="<?php echo BASEURL ?>assets/img/gallery/arrival7.png" alt="">
                        <div class="favorit-items">
                            <!-- <span class="flaticon-heart"></span> -->
                            <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="single-new-arrival mb-50 text-center">
                <div class="popular-img">
                    <img src="<?php echo BASEURL ?>assets/img/gallery/arrival8.png" alt="">
                    <div class="favorit-items">
                        <!-- <span class="flaticon-heart"></span> -->
                        <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                    </div>
    ...
    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
        <div class="single-new-arrival mb-50 text-center">
            <div class="popular-img">
                <img src="<?php echo BASEURL ?>assets/img/gallery/arrival1.png" alt="">
                <div class="favorit-items">
                    <!-- <span class="flaticon-heart"></span> -->
                    <img src="<?php echo BASEURL ?>assets/img/gallery/favorit-card.png" alt="">
                </div>
