...
<script src="<?php echo BASEURL ?>assets/js/vendor/modernizr-3.5.0.min.js"></script>
<script src="<?php echo BASEURL ?>assets/js/vendor/jquery-1.12.4.min.js"></script>
...
<script src="<?php echo BASEURL ?>assets/js/jquery.slicknav.min.js"></script>

<!-- One Page, Animated-HeadLin, Date Picker -->
<script src="<?php echo BASEURL ?>assets/js/wow.min.js"></script>
<script src="<?php echo BASEURL ?>assets/js/animated.headline.js"></script>
...
<script src="<?php echo BASEURL ?>assets/js/jquery.nice-select.min.js"></script>
<script src="<?php echo BASEURL ?>assets/js/jquery.sticky.js"></script>
<script src="<?php echo BASEURL ?>assets/js/jquery.barfiller.js"></script>
...
<script src="<?php echo BASEURL ?>assets/js/hover-direction-snake.min.js"></script>

<!-- contact js -->
<script src="<?php echo BASEURL ?>assets/js/contact.js"></script>
<script src="<?php echo BASEURL ?>assets/js/jquery.form.js"></script>
<script src="<?php echo BASEURL ?>assets/js/jquery.validate.min.js"></script>
<script src="<?php echo BASEURL ?>assets/js/mail-script.js"></script>
<script src="<?php echo BASEURL ?>assets/js/jquery.ajaxchimp.min.js"></script>
